...
def main(radius, beam, targets, E0, theta=0.0001, N=10000, N_=1, N_mesh=10):
    ...
    positions = [(-radius -dx, 0., 0.) for _ in range(N)]
    ...
    if np.size(trajectories) > 0:
        ...
        plt.fill(x_boundary, y_boundary, color='darkslateblue', linewidth=0.)
...
if __name__ == '__main__':
    print(main(0.02, hydrogen, [beryllium, boron, nitrogen], 1000., N=10, N_mesh=100))
