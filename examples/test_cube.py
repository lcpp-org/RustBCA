...
def main():
    ...
    for angle_index, angle in enumerate(angles):
        ...
        sim_index += 1
        plt.figure(1)
        if angle_index == 0: plt.hist(implanted[:, 2], histtype='step', bins=100, density=True, label='x')
        ...
        sim_index += 1
        if angle_index == 0: plt.hist(a - implanted[:, 2], histtype='step', bins=100, density=True, label='-x')
        ...
        sim_index += 1
        if angle_index == 0: plt.hist(a - implanted[:, 4], histtype='step', bins=100, density=True, label='-z')
        ...
        sim_index += 1
        if angle_index == 0: plt.hist(implanted[:, 4], histtype='step', bins=100, density=True, label='z')
        ...
        sim_index += 1
        if angle_index == 0: plt.hist(implanted[:, 3], histtype='step', bins=100, density=True, label='y')
        ...
        sim_index += 1
        if angle_index == 0: plt.hist(a - implanted[:, 3], histtype='step', bins=100, density=True, label='-y')
